...
export class CreateOrEditSaleReturnModalComponent extends AppComponentBase {
    ...
    debugger;
        ...
        if (!oeretHeaderId) {
            ...
            this.oeretHeader.docDate =new Date();
            this.oeretHeader.paymentDate = new Date();
            ...
            this._oeretHeadersServiceProxy.getOERETHeaderForEdit(oeretHeaderId).subscribe(result => {
                ...
                if (this.oeretHeader.audtDate) {
					this.auditTime = new Date (this.oeretHeader.audtDate);
                }

                this.typeDesc=result.typeDesc;
                this.locDesc=result.locDesc;
                this.customerName=result.customerName;
                if(this.oeretHeader.docDate == null){
                    this.oeretHeader.docDate = new Date();
                }else{
                    this.oeretHeader.docDate = new Date(this.oeretHeader.docDate);
                }

                //this.LockDocDate= new Date(this.oeretHeader.docDate);
