...
implements OnInit, AfterViewInit {
 ...
 @ViewChild('LogTableModal', { static: true }) LogTableModal: LogComponent;
    ...
    setTermsNull(){
        this.SaleQutationH.delvTerms=null;
        this.allterm="";
    }
    //////////////////////////////////
    ...
    show(id?: number): void {
        ...
        this.SaleQutationH.basicStyle = "0";
        this.SaleQutationH.license = "0";
        this.SaleQutationH.delvTerms = "0";
        if (!id) {
            this._SaleQutationService.GetDocId().subscribe(res => {
                ...
                this.SaleQutationH.commenceDate = new Date();
                this.SaleQutationH.completionDate = new Date();
            ...
            this._SaleQutationService.getDataForEdit(id).subscribe((data: any) => {
                ...
                this.SaleQutationH.commenceDate = new Date(
                    data["result"]["oeqh"]["commenceDate"]
                );
                this.SaleQutationH.completionDate = new Date(
                    data["result"]["oeqh"]["completionDate"]
                );
                debugger
    ...
    checkFormValid() {
        if (
            ...
            this.SaleQutationDData.forEach((val, index) => {
                ...
                //if form requires transtype validations
                // if (val.itemID == undefined || val.qty == undefined) {
                    this.formValid = false;
                } else {
                    this.formValid = true;
