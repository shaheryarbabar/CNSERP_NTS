...
export class SaleEntryServiceProxy {
     ...
     * @return Success
     */
    getItemPriceRate(priceList:string | null | undefined,itemID:string | null | undefined): Observable<number> {debugger;
        let url_ = this.baseUrl + "/api/services/app/SaleEntry/GetItemPriceRate?";
