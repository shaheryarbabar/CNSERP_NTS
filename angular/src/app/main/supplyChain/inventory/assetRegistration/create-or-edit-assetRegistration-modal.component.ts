...
export class CreateOrEditAssetRegistrationModalComponent extends AppComponentBase {
        ...
        if (!assetRegistrationId) {
            ...
            this._assetRegistrationServiceProxy.getAssetRegistrationForEdit(assetRegistrationId).subscribe(result => {
                ...
                if (this.assetRegistration.regDate) {
                    this.regDate =new Date (this.assetRegistration.regDate);
                }
                if (this.assetRegistration.purchaseDate) {
                    this.purchaseDate = new Date (this.assetRegistration.purchaseDate);
                }
                if (this.assetRegistration.expiryDate) {
                    this.expiryDate = new Date (this.assetRegistration.expiryDate);
                }
                if (this.assetRegistration.depStartDate) {
                    this.depStartDate = new Date (this.assetRegistration.depStartDate);
                }
                if (this.assetRegistration.lastDepDate) {
                    this.lastDepDate = new Date (this.assetRegistration.lastDepDate);
                }
                if (this.assetRegistration.audtDate) {
                    this.audtDate = new Date (this.assetRegistration.audtDate);
                }
                if (this.assetRegistration.createDate) {
                    this.createDate = new Date (this.assetRegistration.createDate);
                }
                this.flag = true;
    ...
    save(): void {
        ...
        if (this.regDate) {
            if (!this.assetRegistration.regDate) {
                this.assetRegistration.regDate  =new Date(this.regDate);
            }
            else {
                this.assetRegistration.regDate = new Date(this.regDate);
            }
        ...
        if (this.purchaseDate) {
            if (!this.assetRegistration.purchaseDate) {
                this.assetRegistration.purchaseDate = new Date(this.purchaseDate);
            }
            else {
                this.assetRegistration.purchaseDate = new Date(this.purchaseDate);
            }
        ...
        if (this.expiryDate) {
            if (!this.assetRegistration.expiryDate) {
                this.assetRegistration.expiryDate = new Date(this.expiryDate);
            }
            else {
                this.assetRegistration.expiryDate = new Date(this.expiryDate);
            }
        ...
        if (this.depStartDate) {
            if (!this.assetRegistration.depStartDate) {
                this.assetRegistration.depStartDate = new Date(this.depStartDate);
            }
            else {
                this.assetRegistration.depStartDate = new Date(this.depStartDate);
            }
        ...
        if (this.lastDepDate) {
            if (!this.assetRegistration.lastDepDate) {
                this.assetRegistration.lastDepDate = new Date(this.lastDepDate);
            }
            else {
                this.assetRegistration.lastDepDate = new Date(this.lastDepDate);
            }
        ...
        if (this.audtDate) {
            if (!this.assetRegistration.audtDate) {
                this.assetRegistration.audtDate = new Date(this.audtDate);
            }
            else {
                this.assetRegistration.audtDate = new Date(this.audtDate);
            }
        ...
        if (this.createDate) {
            if (!this.assetRegistration.createDate) {
                this.assetRegistration.createDate = new Date(this.createDate);
            }
            else {
                this.assetRegistration.createDate = new Date(this.createDate);
            }
