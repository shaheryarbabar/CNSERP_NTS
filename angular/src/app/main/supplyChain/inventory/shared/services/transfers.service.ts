...
export class TransfersService {
  ...
  processTransferFrom(dto: TransferDto) {
    debugger
    this.url = this.baseUrl;
    this.url += "/api/services/app/Transfers/ProcessTransferFrom";
    return this.http.post(this.url, dto);
  }
  processTransferTo(dto: TransferDto) {
    debugger
    this.url = this.baseUrl;
    this.url += "/api/services/app/Transfers/ProcessTransferTo";
    return this.http.post(this.url, dto);
  }
//   processTransferFrom(dto: TransferDto | null | undefined): Observable<string>{
//     debugger;
//     let url_ = this.baseUrl + "/api/services/app/Transfers/ProcessTransferFrom";
//         url_ = url_.replace(/[?&]$/, "");
...
//         return this.processTransferFrom(response_);
//     })).pipe(_observableCatch((response_: any) => {
//         debugger;
//         if (response_ instanceof HttpResponseBase) {
//             try {
//                 return this.processTransferFrom(<any>response_);
//             } catch (e) {
...
// processTransferTo(dto: TransferDto | null | undefined): Observable<string>{
//   debugger;
//   let url_ = this.baseUrl + "/api/services/app/Transfers/processTransferTo";
//       url_ = url_.replace(/[?&]$/, "");
...
//   return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
//       return this.processTransferTo(response_);
//   })).pipe(_observableCatch((response_: any) => {
//       debugger;
//       if (response_ instanceof HttpResponseBase) {
//           try {
//               return this.processTransferTo(<any>response_);
//           } catch (e) {
//               return <Observable<string>><any>_observableThrow(e);
//           }
//       } else
