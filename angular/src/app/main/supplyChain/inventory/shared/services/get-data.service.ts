...
export class GetDataService {
    ...
    getDataForLoc(id: number): Observable<GetDataViewDto[]> {
        let url_ = this.baseUrl + "/api/services/app/GetData/GetPLoc?Id=" + id;
    ...
    // getDataForLoc(id: number) {
    //     debugger
    //     let url = this.baseUrl;
    //     url += "/api/services/app/GetData/GetPLoc?Id=" + id;
    //     // this.url += "&type=" + type;
