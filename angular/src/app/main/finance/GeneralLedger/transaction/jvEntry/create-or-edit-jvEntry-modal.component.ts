...
export class CreateOrEditJVEntryModalComponent extends AppComponentBase {
	...
	columnDefs = [
		{ headerName: this.l('SrNo'), field: 'srNo', sortable: false, width: 50, valueGetter: 'node.rowIndex+1' },
		{ headerName: this.l('AccountID'), field: 'accountID', sortable: false, filter: true, width: 120, editable: false, resizable: true },
		{ headerName: this.l(''), field: 'addAccId', width: 15, editable: false, cellRenderer: this.accIdCellRendererFunc, resizable: false },
		{ headerName: this.l('AccountDesc'), field: 'accountDesc', sortable: false, filter: true, width: 200, resizable: true },
		{ headerName: this.l('Subledger'), field: 'subAccID', sortable: false, filter: true, width: 120, editable: false, resizable: true },
		...
		{ headerName: this.l('SubledgerDesc'), field: 'subAccDesc', sortable: false, filter: true, width: 150, resizable: true },
		...
		{ headerName: this.l('Debit'), field: 'debit', sortable: false, width: 100, editable: true, type: "numericColumn", resizable: true, valueFormatter: this.agGridExtend.formatNumber },
		{ headerName: this.l('Credit'), field: 'credit', sortable: false, width: 100, editable: true, type: "numericColumn", resizable: true, valueFormatter: this.agGridExtend.formatNumber },
