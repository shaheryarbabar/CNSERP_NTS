...
export class CreateOrEditAROptionModalComponent extends AppComponentBase {
    ...
    openSelectSLTYPEControlModal() {
        this.target="SLTYPE";
        this.FinanceLookupTableModal.id = this.arOption.sltypeid;
        this.FinanceLookupTableModal.displayName = this.slName;
        this.FinanceLookupTableModal.show(this.target);
    }
    ...
    getNewSLTYPEControlId() {
        this.arOption.sltypeid = this.FinanceLookupTableModal.id;
        this.slName= this.FinanceLookupTableModal.displayName;
    }
    close(): void {
