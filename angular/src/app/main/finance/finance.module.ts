...
import { CreateApinvknockoffComponent } from './accountPayables/apinvknockoff/create-apinvknockoff.component';
@NgModule({
	imports: [
		FormsModule,
		FileUploadModule,
	...
	declarations: [
		...
		ApinvknockoffComponent,
		CreateApinvknockoffComponent
	],
