...
export class CreateOrEditCRDRNoteModalComponent extends AppComponentBase {
        ...
        if (!CRDRNoteId) {
            ...
            this._crdrNoteServiceProxy
                ...
                .subscribe(result => {
                    ...
                    this.docDate = new Date(this.crdrNote.docDate);
                    this.partyInvDate = new Date(
    ...
    save(): void {
        ...
        this.crdrNote.audtDate = new Date();
        this.crdrNote.audtUser = this.appSession.user.userName;

        this.crdrNote.docDate = new Date(this.docDate);
        this.crdrNote.partyInvDate = new Date(this.partyInvDate);

        if (!this.crdrNote.id) {
            this.crdrNote.createDate = new Date();
