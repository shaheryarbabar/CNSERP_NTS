...
import { CreateApinvknockoffComponent } from './create-apinvknockoff.component';
import { apinvoiceKnockOffService } from '../../shared/services/apinvoiceknock.service';

@Component({
  selector: 'app-apinvknockoff',
  templateUrl: './apinvknockoff.component.html',
  encapsulation: ViewEncapsulation.None,
  animations: [appModuleAnimation()]
})
export class ApinvknockoffComponent extends AppComponentBase implements OnInit {
  ...
  @ViewChild('CreateOrEditInvoiceKnockOffComponent', { static: true }) GetInvoiceKnockOffModal: CreateApinvknockoffComponent;
  //@ViewChild('viewAssemblyModal', { static: true }) viewAssemblyModal: ViewAssemblyComponent;
  constructor(injector: Injector,
    private _assemblyService: apinvoiceKnockOffService,
