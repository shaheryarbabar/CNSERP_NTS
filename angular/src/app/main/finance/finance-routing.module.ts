...
import { LedgerMappingComponent } from './GeneralLedger/setupForms/ledger-mapping/ledger-mapping.component';
import { ApinvknockoffComponent } from './accountPayables/apinvknockoff/apinvknockoff.component';
...
const routes: Routes = [
  {
    ...
    children: [ 
      ...
      { path: 'GeneralLedger/setupForms/ledger-mapping', component: LedgerMappingComponent, data: { permission: 'Pages.LedgerMapping' } },
      ...
      { path: 'accountPayables/apinvknockoff', component: ApinvknockoffComponent, data: { permission: 'Pages.APINVKNOCKH' }  },
    ]
