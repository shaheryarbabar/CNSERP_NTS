...
export class CreateOrEditEmployeesModalComponent extends AppComponentBase {
        ...
        if (!EmployeesId) {
            ...
            this._EmployeesServiceProxy
                ...
                .subscribe((result) => {
                    ...
                    //     ).format("DD/MM/YYYY"));
                    if (this.employees.date_of_birth == null) {
                        this.dateOfBirth = "";
                    } else {
                        this.dateOfBirth = new Date(this.employees.date_of_birth);
                    }
                    if (this.employees.apointment_date == null) {
                        this.apointment_date = "";
                    } else {
                        this.apointment_date = new Date(this.employees.apointment_date);
                    }
                    if (this.employees.apointment_date == null) {
                        this.apointment_date = "";
                    } else {
                    ...
                    if (this.employees.date_of_joining == null) {
                        this.date_of_joining = "";
                    } else {
                        this.date_of_joining = new Date(this.employees.date_of_joining);
                    }
                    if (this.employees.contractExpDate == null) {
                        this.contractExpDate = "";
                    } else {
                        this.contractExpDate = new Date(this.employees.contractExpDate);
                    }
                    if (this.employees.reinstateDate == null) {
                        this.reinstateDate = "";
                    } else {
                        this.reinstateDate = new Date(this.employees.reinstateDate);
                    }

                    if (this.employees.active == false) {
                        if (this.employees.date_of_leaving != null) {
                            this.date_of_leaving = new Date(this.employees.date_of_leaving.toString());
                        } else {
                            this.date_of_leaving = "";
                        }
                    }
                    ...
                    // if (this.employees.active == false) {
                    //     if ($("#Employee_DateOfLeaving").val()!= undefined) {
                    //         var test=$("#Employee_DateOfLeaving").val();

                    //         this.employees.date_of_leaving = new Date(test.toLocaleString());
                    //     }
                    // } else {
                    //     this.date_of_leaving = "";
                    // }
    ...
    save(): void {
        ...
        if (this.dateOfBirth != undefined) {
            this.employees.date_of_birth = new Date(this.dateOfBirth.toLocaleString());
        }
        if (this.apointment_date != undefined) {
            this.employees.apointment_date = new Date(this.apointment_date.toLocaleString());
        }
        if (this.date_of_joining != undefined) {
            this.employees.date_of_joining = new Date(this.date_of_joining.toLocaleString());
        }
        if (this.reinstateDate != undefined) {
            this.employees.reinstateDate = new Date(this.reinstateDate.toLocaleString());
        }

        if (this.contractExpDate != undefined) {
            this.employees.contractExpDate = new Date(this.contractExpDate.toLocaleString());
        }
        // if (this.employees.active == false) {
        //     if (this.employees.date_of_leaving != undefined) {
        //         this.employees.date_of_leaving = new Date(this.date_of_leaving.toLocaleString());
        //     }
        // }
        if (this.employees.active == false) {
            if (this.date_of_leaving != undefined) {
                // if ($("#Employee_DateOfLeaving").val()!= undefined) {
                //     var test=$("#Employee_DateOfLeaving").val();
                this.employees.date_of_leaving = new Date(this.date_of_leaving.toLocaleString());
            }
        }
        if (this.employees.active == true){
            this.employees.date_of_leaving = null;
        }

        if (this.employees.reinstate == false) {
            this.employees.reinstateDate = null;
            this.employees.reinstateReason = "";
        }
    ...
    onChange(deviceValue) {
        ...
        this.validate(deviceValue);
        var isValid = true;
        if (deviceValue == 1) {

            $('#Employee_accNo').css('border-color', 'Red');
            $('#Employee_branchCode').css('border-color', 'Red');
            $('#Employee_bank_name').css('border-color', 'Red');
            ...
            $('#Employee_accNo').css('border-color', 'lightgrey');
            $('#Employee_branchCode').css('border-color', 'lightgrey');
            $('#Employee_bank_name').css('border-color', 'lightgrey');
    ...
    validate(deviceValue) {

    }

    onSearchChangeEmployee_accNo(searchValue: string): void {
        debugger;
        console.log(searchValue);
        if ($('#Employee_PaymentMode').val() == 1) {
            if (searchValue != "") {
                $('#Employee_accNo').css('border-color', 'lightgrey');
                if ($('#Employee_bank_name').val() !== "" && $('#Employee_branchCode').val() !== "") {
                    $('#btnSave').prop('disabled', false);
                }
            }
            else {
    ...
    onSearchChangeEmployee_bank_name(searchValue: string): void {
        debugger;
        console.log(searchValue);
        if ($('#Employee_PaymentMode').val() == 1) {
            if (searchValue != "") {
                $('#Employee_bank_name').css('border-color', 'lightgrey');
                if ($('#Employee_accNo').val() !== "" && $('#Employee_branchCode').val() !== "") {
                    $('#btnSave').prop('disabled', false);
                }
            }
            else {
    ...
    onSearchChangeEmployee_branchCode(searchValue: string): void {
        debugger;
        console.log(searchValue);
        if ($('#Employee_PaymentMode').val() == 1) {
            if (searchValue != "") {
                $('#Employee_branchCode').css('border-color', 'lightgrey');
                if ($('#Employee_accNo').val() !== "" && $('#Employee_bank_name').val() !== "") {
                    $('#btnSave').prop('disabled', false);
                }
            }
            else {
