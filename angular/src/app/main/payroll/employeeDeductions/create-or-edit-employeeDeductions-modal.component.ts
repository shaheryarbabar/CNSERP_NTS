...
export class CreateOrEditEmployeeDeductionsModalComponent extends AppComponentBase {
        ...
        if (!adjHId) {
            ...
            this._adjHServiceProxy
                ...
                .subscribe((result) => {
                    ...
                    this.headerInfo.docdate = new Date(result.AdjHDto.docdate);
                    //this.salaryMonth = ("0" + String(this.headerInfo.salaryMonth)).slice(-2);
                    this.salaryMonth = String(this.headerInfo.salaryMonth);
    ...
    save(): void {
        ...
        if (this.gridApi.getDisplayedRowCount() <= 0) {
            this.message.warn("No Employee details found", "Employee Details Required");
            throw new Error();
        }
        debugger
        this.saving = true;
