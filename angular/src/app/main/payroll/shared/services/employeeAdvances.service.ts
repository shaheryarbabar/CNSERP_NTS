...
export class EmployeeAdvancesServiceProxy {
    ...
    appAdv(id:any,stat:number){
        debugger
        let url;
        url = this.baseUrl;
        url += "/api/services/app/EmployeeAdvances/statusAdvance?Id=" + id+"&&stat="+stat;
        return this.http.get(url).pipe(map((response: any) => {
           
            return response["result"];
        }));
    }
    ProcessAdvance(id:any){
        let url;
        url = this.baseUrl;
        url += "/api/services/app/EmployeeAdvances/ProcessAdvance?Id=" + id;
        return this.http.get(url).pipe(map((response: any) => {
