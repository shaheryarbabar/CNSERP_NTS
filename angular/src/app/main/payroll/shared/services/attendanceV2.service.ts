...
export class AttendanceServiceProxy {
     ...
     * @return Success
     */
    markWholeMonthAttendance(fromDate: moment.Moment | null | undefined, toDate: moment.Moment | null | undefined, FromEmpID: number | null | undefined, ToEmpID: number | null | undefined): Observable<string> {
        debugger;
        ...
        if (FromEmpID !== undefined)
            url_ += "FromEmpID=" + FromEmpID + "&";
        if (ToEmpID !== undefined)
            url_ += "ToEmpID=" + ToEmpID + "&";
        url_ = url_.replace(/[?&]$/, "");
