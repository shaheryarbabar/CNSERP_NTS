...
export class SalarySheetComponent extends AppComponentBase {
    ...
    scheduleAttendance(): void {
        ...
        // if (this.employeeID != 0 || undefined || null)
        // {
        //     this.FromEmpID = this.employeeID;
        //     this.ToEmpID = this.employeeID;
        // }
        // else {
        //     this.FromEmpID = 0;
        //     this.ToEmpID = 9999999;
        // }
    ...
    markWholeMonthAttendance(): void {
        ...
        if (this.employeeID == 0 || this.employeeID == null || this.employeeID == undefined)
        {
            this.FromEmpID = 0;
            this.ToEmpID = 9999999;
        }
        ...
        this._attendanceServiceProxy.markWholeMonthAttendance(moment(this.fromDate).startOf('day'), moment(this.toDate).startOf('day'), this.FromEmpID, this.ToEmpID).subscribe(result => {
            debugger
            if (result == "done") {
