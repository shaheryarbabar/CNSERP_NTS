...
import {SaleActivityReportsComponent } from './supplyChain/sale/sale-activity-reports/sale-activity-reports.component';
  ...
  imports: [RouterModule.forChild([

    {
      ...
      children: [
        ...
        { path: 'supplyChain/sale/sale-activity-reports', component: SaleActivityReportsComponent, data: { permission: 'SaleReports.Activity' } }
