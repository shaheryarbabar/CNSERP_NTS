...
export class ItemLedgerComponent extends AppComponentBase {
    ...
    getPLocationList(): void {
        this._getDataService.getList("PLocation").subscribe(resultL => {
            this.plocList = resultL;
        });
    ...
    GetPID(event:any){
     ...
     // this.locationList=[];
      ...
      this._getDataService.getDataForLoc(val).subscribe(resultL => {
          debugger
        //   this.locationList=[];
         this.locationList = resultL;
    ...
    this.dropdownSettings = {
      ...
      //this.locIdlist=[];
    //   var text1=event.target['options']
    //   [event.target['options'].selectedIndex].text;
    //   this.locIdlist.push({id:val,displayName:text1});
    }
    ...
    hideFields() {
        ...
        if(this.itemLedger=="itemStatus"){
          ...
          this.standard=true;
            ...
            this.standard=false;this.ploc=false;
            this.dtloc=false;
            this.ftdate=false;
            this.itemlist=true;
            ...
            this.Fromseg3s=false;
            this.itemlist=false;
            this.dtloc=true;this.ploc=false;
            this.ftdate=true;
            this.standard=true;
        }else if(this.itemLedger=="quantitativeStock"){
            this.Fromseg3s=false;
            this.itemlist=false;
            this.dtloc=true;
            this.ftdate=true;
            this.standard=true;this.ploc=true;
        }else{
            this.Fromseg3s=false;
            this.itemlist=false;
            this.dtloc=true;
            this.ftdate=true;
            this.standard=true;this.ploc=false;
        }
