...
namespace ERP.EntityFrameworkCore
{
    ...
    {
        public virtual DbSet<SupplyChain.Sales.SaleTerm.OETerms.OETerms> OETerms { get; set; }

        public virtual DbSet<AccountPayables.InvoiceKnock.APINVKNOCKD.APINVKNOCKD> APINVKNOCKD { get; set; }

        public virtual DbSet<AccountPayables.InvoiceKnock.APINVKNOCKH.APINVKNOCKH> APINVKNOCKH { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OETerms>(o =>
            {
                o.HasIndex(e => new { e.TenantId });
            });
            modelBuilder.Entity<APINVKNOCKD>(a =>
                       {
                           a.HasIndex(e => new { e.TenantId });
                       });
            modelBuilder.Entity<APINVKNOCKH>(a =>
                       {
                           a.HasIndex(e => new { e.TenantId });
                       });
