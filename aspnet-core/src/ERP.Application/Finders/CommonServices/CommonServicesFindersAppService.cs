...
using static ERP.Reports.SupplyChain.Inventory.Dtos.AgeingInvoiceListingDto;
    ...
    public class CommonServicesFindersAppService : ERPAppServiceBase
    {
        ...
        public CommonServicesFindersAppService(
            ...
            IRepository<RecurringVoucher> recurringVoucherRepository,
             IRepository<Requisitions> requisitionRepository, IRepository<GLCONFIG> glconfigRepository,
        ...
        public async Task<List<CommonServiceFindersDto>> GetTermsList()
        {
            SqlCommand cmd;
            string str = ConfigurationManager.AppSettings["ConnectionString"];
            List<CommonServiceFindersDto> FormList = new List<CommonServiceFindersDto>();
            using (SqlConnection cn = new SqlConnection(str))
            {
                cmd = new SqlCommand("sp_OETerms", cn);
                ...
                using (SqlDataReader rdr = cmd.ExecuteReader())
                {
                    while (rdr.Read())
                    {
                        CommonServiceFindersDto form = new CommonServiceFindersDto()
                        {
                            Id = rdr["TermID"] is DBNull ? "" : (rdr["TermID"]).ToString(),
                            DisplayName = rdr["TermDesc"] is DBNull ? "" : rdr["TermDesc"].ToString(),
        ...
        private async Task<LookupDto<CommonServiceFindersDto>> GetAllGLConfigForLookupTable(GetAllForLookupTableInput input)
        {
