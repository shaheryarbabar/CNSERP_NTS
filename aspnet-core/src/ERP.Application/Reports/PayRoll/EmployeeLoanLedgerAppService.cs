                ...
                using (SqlDataReader rdr = cmd.ExecuteReader())
                {
                    while (rdr.Read())
                    {
                        EmployeeLoanLedger employeeLoanLedger = new EmployeeLoanLedger()
                        {
                            ...
                            EmpType = rdr["EmpType"] is DBNull ? "" : rdr["EmpType"].ToString(),
                            ...
                            AMT = rdr["AMT"] is DBNull ? 0 : Convert.ToDouble(rdr["AMT"]),
                            AdjustAmt = rdr["AdjustAmt"] is DBNull ? 0 : Convert.ToDouble(rdr["AdjustAmt"]),
                        };
