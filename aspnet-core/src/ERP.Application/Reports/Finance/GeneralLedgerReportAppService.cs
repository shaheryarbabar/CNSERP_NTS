                        ...
                        while (rdr.Read())
                        {
                            ...
                            if (!DBNull.Value.Equals(rdr["DocDate"]))
                            {
                                GeneralLedgerDto generalLedgerDto = new GeneralLedgerDto()
                                {
                                    ...
                                    DocNo = !DBNull.Value.Equals(rdr["DocNo"].ToString()) ? Convert.ToInt32(rdr["DocNo"].ToString()) : 0,
                                    FmtDocNo = !DBNull.Value.Equals(rdr["FmtDocNo"].ToString()) ? (rdr["FmtDocNo"].ToString()) : "",
