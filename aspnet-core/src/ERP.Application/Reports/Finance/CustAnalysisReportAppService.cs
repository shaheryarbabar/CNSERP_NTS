...
namespace ERP.Reports.Finance
{
    ...
    {
        public List<GeneralLedgerDto> GetCustAnalysisReport(DateTime fromDate, DateTime toDate, string status, int slType, string fromAcc, string toAcc, string fromSubAcc, string toSubAcc ,int? curRate, string loc)
        {
