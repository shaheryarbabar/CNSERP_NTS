...
namespace ERP.Reports.Finance
{
    public class SubledgerReportAppService : ERPReportAppServiceBase
    {
        ...
        public List<SubedgerDto> GetSubledger(string text, DateTime fromDate, DateTime toDate, string fromAC, string toAC, int fromSubledgerId, int toSubledgerId, string locId,
