...
using ERP.SupplyChain.Sales.SaleTerm.OETerms;
using ERP.AccountPayables.InvoiceKnock.APINVKNOCKD.Dtos;
using ERP.AccountPayables.InvoiceKnock.APINVKNOCKD;
using ERP.AccountPayables.InvoiceKnock.APINVKNOCKH.Dtos;
using ERP.AccountPayables.InvoiceKnock.APINVKNOCKH;
...
namespace ERP
{
    internal static class CustomDtoMapper
    {
        ...
        {
            configuration.CreateMap<CreateOrEditOETermsDto, SupplyChain.Sales.SaleTerm.OETerms.OETerms>().ReverseMap();
            configuration.CreateMap<OETermsDto, SupplyChain.Sales.SaleTerm.OETerms.OETerms>().ReverseMap();
            configuration.CreateMap<CreateOrEditAPINVKNOCKDDto, AccountPayables.InvoiceKnock.APINVKNOCKD.APINVKNOCKD>().ReverseMap();
            configuration.CreateMap<APINVKNOCKDDto, AccountPayables.InvoiceKnock.APINVKNOCKD.APINVKNOCKD>().ReverseMap();
            configuration.CreateMap<CreateOrEditAPINVKNOCKHDto, AccountPayables.InvoiceKnock.APINVKNOCKH.APINVKNOCKH>().ReverseMap();
            configuration.CreateMap<APINVKNOCKHDto, AccountPayables.InvoiceKnock.APINVKNOCKH.APINVKNOCKH>().ReverseMap();
