...
namespace ERP.Reports.Finance
{
    ...
    {
        List<TrialBalanceDto> GetData(int TenantId, DateTime FromDate, DateTime ToDate, string FromAcc, string ToAcc, string status, int locId, bool includeZeroBalance, int? curRate);
    }
