...
namespace ERP.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var oeTerms = pages.CreateChildPermission(AppPermissions.Sales_OETerms, L("OETerms"), multiTenancySides: MultiTenancySides.Tenant);
            oeTerms.CreateChildPermission(AppPermissions.Sales_OETerms_Create, L("CreateNewOETerms"), multiTenancySides: MultiTenancySides.Tenant);
            oeTerms.CreateChildPermission(AppPermissions.Sales_OETerms_Edit, L("EditOETerms"), multiTenancySides: MultiTenancySides.Tenant);
            oeTerms.CreateChildPermission(AppPermissions.Sales_OETerms_Delete, L("DeleteOETerms"), multiTenancySides: MultiTenancySides.Tenant);
            ...
            lcExpensesDetail.CreateChildPermission(AppPermissions.Pages_LCExpensesDetail_Complete, L("CompleteLCExpensesDetail"), multiTenancySides: MultiTenancySides.Tenant);
            ...
            var ledgerMapping = pages.CreateChildPermission(AppPermissions.Pages_LedgerMapping, L("LedgerMapping"), multiTenancySides: MultiTenancySides.Tenant);
            ledgerTypes.CreateChildPermission(AppPermissions.Pages_LedgerMapping_Create, L("CreateNewLedgerMapping"), multiTenancySides: MultiTenancySides.Tenant);
            ledgerTypes.CreateChildPermission(AppPermissions.Pages_LedgerMapping_Edit, L("EditLedgerMapping"), multiTenancySides: MultiTenancySides.Tenant);
            ledgerTypes.CreateChildPermission(AppPermissions.Pages_LedgerMapping_Delete, L("DeleteLedgerMapping"), multiTenancySides: MultiTenancySides.Tenant);
            ...
            saleReports.CreateChildPermission(AppPermissions.SaleReports_Activity, L("Activity"));
            ...
            EmpAdvance.CreateChildPermission(AppPermissions.PayRoll_EmployeeAdvances_Approve, L("ApproveEmployeeAdvances"));
            EmpAdvance.CreateChildPermission(AppPermissions.PayRoll_EmployeeAdvances_UnApprove, L("UnApproveEmployeeAdvances"));
            ...
            transfers.CreateChildPermission(AppPermissions.Inventory_Transfers_ProcessFrom, L("Process"), multiTenancySides: MultiTenancySides.Tenant);
            transfers.CreateChildPermission(AppPermissions.Inventory_Transfers_ProcessTo, L("Process"), multiTenancySides: MultiTenancySides.Tenant);
            ...
            transfers.CreateChildPermission(AppPermissions.Inventory_Transfers_Post, L("Post"), multiTenancySides: MultiTenancySides.Tenant);
            ...
            var apinvknockd = pages.CreateChildPermission(AppPermissions.Pages_APINVKNOCKD, L("APINVKNOCKD"), multiTenancySides: MultiTenancySides.Tenant);
            apinvknockd.CreateChildPermission(AppPermissions.Pages_APINVKNOCKD_Create, L("CreateNewAPINVKNOCKD"), multiTenancySides: MultiTenancySides.Tenant);
            apinvknockd.CreateChildPermission(AppPermissions.Pages_APINVKNOCKD_Edit, L("EditAPINVKNOCKD"), multiTenancySides: MultiTenancySides.Tenant);
            apinvknockd.CreateChildPermission(AppPermissions.Pages_APINVKNOCKD_Delete, L("DeleteAPINVKNOCKD"), multiTenancySides: MultiTenancySides.Tenant);

            var apinvknockh = pages.CreateChildPermission(AppPermissions.Pages_APINVKNOCKH, L("APINVKNOCKH"), multiTenancySides: MultiTenancySides.Tenant);
            apinvknockh.CreateChildPermission(AppPermissions.Pages_APINVKNOCKH_Create, L("CreateNewAPINVKNOCKH"), multiTenancySides: MultiTenancySides.Tenant);
            apinvknockh.CreateChildPermission(AppPermissions.Pages_APINVKNOCKH_Edit, L("EditAPINVKNOCKH"), multiTenancySides: MultiTenancySides.Tenant);
            apinvknockh.CreateChildPermission(AppPermissions.Pages_APINVKNOCKH_Delete, L("DeleteAPINVKNOCKH"), multiTenancySides: MultiTenancySides.Tenant);
            apinvknockh.CreateChildPermission(AppPermissions.Pages_APINVKNOCKH_Approved, L("ApprovedAPINVKNOCKH"), multiTenancySides: MultiTenancySides.Tenant);
