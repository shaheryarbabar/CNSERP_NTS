...
using PurchaseOrderGoodsReceiveNote = ERP.Reports.SupplyChain.Inventory.PurchaseOrderGoodsReceiveNoteAppService.PurchaseOrderGoodsReceiveNote;
...
namespace ERP.Web.DXServices.DataHandler
{
    ...
    public class ReportDataHandlerBase
    {
        ...
        private static SalarySheetListingAppService SalarySheetListingAppService;
        private static DeductionRegisterListingAppService DeductionRegisterListingAppService;
        private static AllowanceRegisterListingAppService AllowanceRegisterListingAppService;
        ...
        private static PurchaseOrderGoodsReceiveNoteAppService _PurchaseOrderGoodsReceiveNoteAppService;
        ...
        static ReportDataHandlerBase()
        {
            ...
            SalarySheetListingAppService = IocManager.Instance.Resolve<SalarySheetListingAppService>();
            AllowanceRegisterListingAppService = IocManager.Instance.Resolve<AllowanceRegisterListingAppService>();
            DeductionRegisterListingAppService = IocManager.Instance.Resolve<DeductionRegisterListingAppService>();
            ...
            _PurchaseOrderGoodsReceiveNoteAppService = IocManager.Instance.Resolve<PurchaseOrderGoodsReceiveNoteAppService>();
        ...
        public static List<GeneralLedgerDto> GetCustAnalysis(DateTime fromDate, DateTime toDate, string status, int slType, string fromAcc, string toAcc, string fromSubAcc, string toSubAcc, int? curRate, string loc)
        {
        ...
        public static List<SubedgerDto> GetSubledger(string text,DateTime fromDate, DateTime toDate, string fromAC, string toAC, int fromSubledgerId, int toSubledgerId, string locId, int slType, string status, int? curRate)
        {
    ...
    string fromDeptID, string toDeptID, string fromSecID, string toSecID, string AllowanceYear, string allowanceMonth, bool isActive, string fromlocid, string tolocid, string Allowtype, string EmpType, string allowanceBtype)
        ...
        public static List<ERP.Reports.PayRoll.SalarySheetListingDto> GetSalarySheetListing(int? TenantID, string fromEmpID, string toEmpID,
            string fromDeptID, string toDeptID, string fromSecID, string toSecID, string fromSalary, string toSalary, short SalaryMonth, short SalaryYear, string fromLocId, string ToLocId, string Emptype, string Employee_PaymentMode)
        {
            return SalarySheetListingAppService.GetData(TenantID, fromEmpID, toEmpID, fromDeptID, toDeptID, fromSecID, toSecID, fromSalary, toSalary, SalaryMonth, SalaryYear, fromLocId, ToLocId, Emptype, Employee_PaymentMode);
        }


        public static List<DeductionRegisterListingDto> GetDeductionRegisterListing(int? TenantID, string fromEmpID, string toEmpID,
        ...
        {
            return DeductionRegisterListingAppService.GetData(TenantID, fromEmpID, toEmpID, fromDeptID, toDeptID, fromSecID, toSecID, fromSalary, toSalary, SalaryMonth, SalaryYear, fromLocId, ToLocId, Emptype);
        }
        public static List<AllowanceRegisterListingDto> GetAllowanceRegisterListing(int? TenantID, string fromEmpID, string toEmpID,
         string fromDeptID, string toDeptID, string fromSecID, string toSecID, string fromSalary, string toSalary, short SalaryMonth, short SalaryYear, string fromLocId, string ToLocId, string Emptype)
        {
            return AllowanceRegisterListingAppService.GetData(TenantID, fromEmpID, toEmpID, fromDeptID, toDeptID, fromSecID, toSecID, fromSalary, toSalary, SalaryMonth, SalaryYear, fromLocId, ToLocId, Emptype);
        }
        ...
        public static List<TrialBalanceDto> GetTrialBalance(int TenantId, DateTime FromDate, DateTime ToDate, string FromAcc, string ToAcc, string status, int locId, bool includeZeroBalance, int? curRate)
        {
        ...
        public static List<PurchaseOrderStatus> GetPurchaseOrderStatusReport(int fromDoc, int toDoc, string fromDate, string toDate, string fromArDate, string toArDate, int comp, int fromSubAccId, int toSubAccId, string toItem, string fromItem)
        {
            return _purchaseOrderStatusReportAppService.GetData(fromDoc, toDoc, fromDate, toDate, fromArDate, toArDate, comp, fromSubAccId, toSubAccId, toItem,fromItem);
        }
        ...
        public static List<PurchaseOrderGoodsReceiveNote> GetPOGRN(string fromDoc, string toDoc)
        {
            return _PurchaseOrderGoodsReceiveNoteAppService.GetPOGRN(fromDoc,toDoc);
        }
        ...
        public static List<SaleOrderSummary> GetSaleOrderSummaryReport (int fromDocNo , int toDocNo)
        {
            return _invoiceAppService.GetSaleOrderSummaryReport(fromDocNo, toDocNo);
        }
    }
}
