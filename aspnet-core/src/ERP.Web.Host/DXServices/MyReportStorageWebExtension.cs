                 ...
                 case "cashflowstatement":
                    ...
                    case "SalarySheet":
                        ...
                        string salarySheetListingjson = JsonConvert.SerializeObject(
                                                    ReportDataHandlerBase.GetSalarySheetListing(null, fromEmpID, toEmpID, fromDeptID, toDeptID, fromSecID, toSecID, fromSalary, toSalary, salaryMonth, salaryYear, fromLocId, toLocId, Emptype, payment));
                    ...
                    case "DeductionRegister":
                        ...
                        string deductionregisterListingjson = JsonConvert.SerializeObject(
                                                    ReportDataHandlerBase.GetDeductionRegisterListing(null, fromEmpID, toEmpID, fromDeptID, toDeptID, fromSecID, toSecID, fromSalary, toSalary, salaryMonth, salaryYear, fromLocId, toLocId, Emptype));
                    ...
                    case "AllowanceRegister":
                        ...
                        string alloawanceregisterListingjson = JsonConvert.SerializeObject(
                                                    ReportDataHandlerBase.GetAllowanceRegisterListing(null, fromEmpID, toEmpID, fromDeptID, toDeptID, fromSecID, toSecID, fromSalary, toSalary, salaryMonth, salaryYear, fromLocId, toLocId, Emptype));
                    ...
                    case "Subledger":
                        ...
                        string rptSLJson = JsonConvert.SerializeObject(
                                                    ReportDataHandlerBase.GetSubledger(text,DateTime.Parse(paramHolder[0]), DateTime.Parse(paramHolder[1]), paramHolder[2], paramHolder[3], Convert.ToInt32(paramHolder[4]), Convert.ToInt32(paramHolder[5]), paramHolder[6], Convert.ToInt32(paramHolder[7]), paramHolder[8], Convert.ToInt32(paramHolder[9])));
                    ...
                    case "CustAnalysisReport":
                        ...
                        string custAnalysisJson = JsonConvert.SerializeObject(
                                                    ReportDataHandlerBase.GetCustAnalysis(DateTime.Parse(paramHolder[0]), DateTime.Parse(paramHolder[1]), paramHolder[2], Convert.ToInt32(paramHolder[3]), paramHolder[4], paramHolder[5], paramHolder[6], paramHolder[7], Convert.ToInt32(paramHolder[8]), paramHolder[9]));
                    ...
                    case "TrialBalance":
                        ...
                        string trialBalanceJson = JsonConvert.SerializeObject(
                                                    ReportDataHandlerBase.GetTrialBalance(0, Convert.ToDateTime(paramHolder[0]), Convert.ToDateTime(paramHolder[1]), paramHolder[2], paramHolder[3], paramHolder[5], Convert.ToInt32(paramHolder[4]), Convert.ToBoolean(paramHolder[7]), Convert.ToInt32(paramHolder[8])));
                    ...
                    case "PurchaseOrderStatus":
                        ...
                        string purchaseOrderStatusJson = JsonConvert.SerializeObject(
                            ReportDataHandlerBase.GetPurchaseOrderStatusReport(Convert.ToInt32(paramHolder[0]), Convert.ToInt32(paramHolder[1]), paramHolder[2], paramHolder[3], paramHolder[4], paramHolder[5], Convert.ToInt32(paramHolder[6]), Convert.ToInt32(paramHolder[7]), Convert.ToInt32(paramHolder[8]), paramHolder[9], paramHolder[10]));
                        ...
                        //purchaseOrderStatus.Parameters["SubAccId"].Value = Convert.ToInt32(paramHolder[6]);
                        ...
                        //purchaseOrderStatus.Parameters["fromItem"].Value = Convert.ToInt32(paramHolder[9]);
                        //purchaseOrderStatus.Parameters["toItem"].Value = Convert.ToInt32(paramHolder[10]);
                    ...
                    case "POGRNS":
                        initPointInfo();
                        XtraReport POGRNS = new Reports.Inventory.PurchaseOrderGoodsReceiveNote();
                        fromCode = paramHolder[0];
                        toCode = paramHolder[1];
                        POGRNS.Parameters["CompanyName"].Value = CompanyName;
                        POGRNS.Parameters["TenantId"].Value = tenantId;
                        POGRNS.Parameters["Address"].Value = Address;
                        POGRNS.Parameters["Address2"].Value = Address2;
                        POGRNS.Parameters["Phone"].Value = Phone;
                        //inwardGatePassRegister.Parameters["FromDate"].Value = Convert.ToDateTime(paramHolder[0]);
                        //inwardGatePassRegister.Parameters["ToDate"].Value = Convert.ToDateTime(paramHolder[1]);
                        
                        ////POGRNS.Parameters["FromDoc"].Value = Convert.ToInt32(paramHolder[2]);
                        ////POGRNS.Parameters["ToDoc"].Value = Convert.ToInt32(paramHolder[3]);
                     
                        string POGRNSJson = JsonConvert.SerializeObject(
                                                    ReportDataHandlerBase.GetPOGRN(fromCode, toCode));
                        ((DevExpress.DataAccess.Json.CustomJsonSource)((DevExpress.DataAccess.Json.JsonDataSource)POGRNS.DataSource).JsonSource).Json = POGRNSJson;
                        POGRNS.SaveLayoutToXml(ms);
                    ...
                    case "SaleOrderSummary" :
                        XtraReport SaleOrderSummary = new Reports.Sales.SaleOrderSummary();
        
                        SaleOrderSummary.Parameters["CompanyName"].Value = CompanyName;
                        SaleOrderSummary.Parameters["Address"].Value = Address + "-" + Address2;
                        SaleOrderSummary.Parameters["Phone"].Value = Phone;
                        SaleOrderSummary.Parameters["TenantId"].Value = tenantId;
                        //SaleOrderSummary.Parameters["fromDocNo"].Value = Convert.ToDateTime(paramHolder[1]);
                        //SaleOrderSummary.Parameters["toDocNo"].Value = Convert.ToDateTime(paramHolder[2]);
                        string SaleOrderSummaryJson = JsonConvert.SerializeObject(
                                                    ReportDataHandlerBase.GetSaleOrderSummaryReport(Convert.ToInt32(paramHolder[0]), Convert.ToInt32(paramHolder[1])
                                                     ));
                        ((DevExpress.DataAccess.Json.CustomJsonSource)((DevExpress.DataAccess.Json.JsonDataSource)SaleOrderSummary.DataSource).JsonSource).Json = SaleOrderSummaryJson;
                        SaleOrderSummary.SaveLayoutToXml(ms);
                        break;
                    default:
                        break;
                }
